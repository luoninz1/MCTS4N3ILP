...
if __name__ == "__main__":
    ...
    parser.add_argument("--symmetric_action", type=str, default="vertical_flip_then_horizontal_flip", help="Symmetric action mode (e.g., 'vertical_flip_then_horizontal_flip_then_diagonal_flip')")
