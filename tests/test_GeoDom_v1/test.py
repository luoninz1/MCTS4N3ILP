...
if __name__ == "__main__":
    ...
    parser.add_argument("--start", type=int, default=16, help="Starting value of n (inclusive)")
    parser.add_argument("--end", type=int, default=17, help="Ending value of n (exclusive)")
    ...
    parser.add_argument("--symmetric_action", type=str, default="diagonal_flip_then_anti_diagonal_flip", help="Symmetric action mode (e.g., 'vertical_flip_then_horizontal_flip_then_diagonal_flip')")
    parser.add_argument("--environment", type=str, default="GeometricDominating", help="Environment name")
    parser.add_argument("--algorithm", type=str, default="MCTS_Tree_Reuse", help="Algorithm name")
    parser.add_argument("--reward", type=str, default="exp_reverse", 
