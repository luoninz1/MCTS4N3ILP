...
if __name__ == "__main__":
    ...
    parser.add_argument("--start", type=int, default=28, help="Starting value of n (inclusive)")
    parser.add_argument("--end", type=int, default=30, help="Ending value of n (exclusive)")
