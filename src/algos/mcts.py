...
def evaluate(args):
    """
    Legacy wrapper for experiment runner. Delegates to src.experiments.runner.

    DEPRECATED: Use src.experiments.runner.run_experiment() directly.
    This wrapper maintained for backward compatibility with existing test scripts.
    """
